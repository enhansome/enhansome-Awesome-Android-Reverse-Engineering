...
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,606 | 🐛 20 | 🌐 JavaScript | 📅 2026-08-17 - Supports both static and dynamic analysis for Android app security testing.
...
* [Quark Engine](https://github.com/quark-engine/quark-engine) ⭐ 1,710 | 🐛 77 | 🌐 Python | 📅 2026-08-15 - Integrates various tools as Quark Script APIs for mobile security research.
...
* [Drozer](https://github.com/WithSecureLabs/drozer) ⭐ 4,593 | 🐛 9 | 🌐 Python | 📅 2026-04-08 - Framework for Android security testing with dynamic analysis features.
...
* **Networking:**
  * [apk-mitm](https://github.com/shroudedcode/apk-mitm) ⭐ 5,080 | 🐛 83 | 🌐 TypeScript | 📅 2024-07-24 - Prepares APKs for HTTPS inspection.
  * [SSLsplit](https://github.com/droe/sslsplit) ⭐ 1,874 | 🐛 76 | 🌐 C | 📅 2025-10-27 - Intercepts and manipulates SSL/TLS encrypted traffic.
...
* **Dynamic Instrumentation:**
  * [☆ Objection](https://github.com/sensepost/objection) ⭐ 9,321 | 🐛 55 | 🌐 Python | 📅 2026-07-23 - Runtime exploration tool to bypass app security controls.
  * [RMS Runtime Mobile Security](https://github.com/m0bilesecurity/RMS-Runtime-Mobile-Security) ⭐ 3,070 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-03 - Frida web interface.
  * [jnitrace](https://github.com/chame1eon/jnitrace) ⭐ 1,857 | 🐛 20 | 🌐 TypeScript | 📅 2023-07-18 - Frida-based JNI API tracer.
  * [☆ FriDump](https://github.com/Nightbringer21/fridump) ⭐ 856 | 🐛 26 | 🌐 Python | 📅 2024-08-07 - Uses Frida to dump memory of running apps.
  * [☆ Binder Trace](https://github.com/foundryzero/binder-trace) ⭐ 767 | 🐛 11 | 🌐 Python | 📅 2025-09-11 - Intercepts and parses Android Binder messages.
...
* [☆ JADX](https://github.com/skylot/jadx) ⭐ 50,109 | 🐛 443 | 🌐 Java | 📅 2026-08-05 - Decompiles APKs into Java source code.
* [FernFlower](https://github.com/JetBrains/intellij-community/tree/master/plugins/java-decompiler/engine) ⭐ 20,459 | 🐛 157 | 🌐 Java | 📅 2026-08-18 - Analytical decompiler for Java.
* [DEX2JAR](https://github.com/pxb1988/dex2jar) ⭐ 13,132 | 🐛 379 | 🌐 Java | 📅 2024-07-21 - Converts DEX files to JAR files.
* [Cfr](https://github.com/leibnitz27/cfr) ⭐ 2,665 | 🐛 150 | 🌐 Java | 📅 2026-06-04 - Supports decompilation of Android APK files.
* [Procyon](https://github.com/mstrobel/procyon) ⭐ 1,210 | 🐛 59 | 🌐 Java | 📅 2022-06-12 - Suite of Java decompilation tools.
...
* **Additional Decompilers:**
  * [Androguard](https://github.com/androguard/androguard) ⭐ 6,195 | 🐛 46 | 🌐 Python | 📅 2026-08-13 - Analyzes and reverse engineers Android apps.
  * [APK Studio](https://github.com/vaibhavpandeyvpz/apkstudio) ⭐ 4,607 | 🐛 3 | 🌐 C++ | 📅 2026-01-05 - Qt-based IDE for reverse-engineering APKs.
...
* [Android Reverse Engineering Challenges](https://github.com/apsdehal/awesome-ctf#reverse-engineering) ⭐ 11,762 | 🐛 64 | 🌐 JavaScript | 📅 2024-07-22 - Curated list of reverse engineering challenges and CTFs.
...
* [☆ UnCrackable Mobile Apps](https://github.com/OWASP/owasp-mastg/tree/master/Crackmes) ⭐ 13,119 | 🐛 231 | 🌐 Python | 📅 2026-08-14 - OWASP Android app CrackMes.
...
* [uber-apk-signer](https://github.com/patrickfav/uber-apk-signer) ⭐ 2,707 | 🐛 11 | 🌐 Java | 📅 2023-10-30 - CLI tool for signing and zip aligning APKs.
* [LADB](https://github.com/tytydraco/LADB) ⭐ 2,385 | 🐛 53 | 🌐 Kotlin | 📅 2026-07-26 - Local ADB shell for Android.
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,233 | 🐛 92 | 🌐 Rust | 📅 2026-08-11 - Analyze, extract, and reverse engineer firmware images.
* [FirmWire](https://github.com/FirmWire/FirmWire) ⭐ 875 | 🐛 17 | 🌐 Python | 📅 2026-07-11 - Dynamic analysis platform for baseband firmware.
