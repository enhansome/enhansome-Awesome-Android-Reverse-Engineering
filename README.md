...
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,810 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-22 - Supports both static and dynamic analysis for Android app security testing.
...
* [Quark Engine](https://github.com/quark-engine/quark-engine) ⭐ 1,724 | 🐛 77 | 🌐 Python | 📅 2026-09-19 - Integrates various tools as Quark Script APIs for mobile security research.
...
* [simplify](https://github.com/CalebFenton/simplify) ⭐ 4,666 | 🐛 33 | 🌐 Java | 📅 2022-04-30 - Android virtual machine and deobfuscator.
...
* [Drozer](https://github.com/WithSecureLabs/drozer) ⭐ 4,619 | 🐛 9 | 🌐 Python | 📅 2026-04-08 - Framework for Android security testing with dynamic analysis features.
...
* **Dynamic Instrumentation:**
  * [☆ Objection](https://github.com/sensepost/objection) ⭐ 9,402 | 🐛 58 | 🌐 Python | 📅 2026-09-17 - Runtime exploration tool to bypass app security controls.
  ...
  * [jnitrace](https://github.com/chame1eon/jnitrace) ⭐ 1,860 | 🐛 20 | 🌐 TypeScript | 📅 2023-07-18 - Frida-based JNI API tracer.
...
* [☆ JADX](https://github.com/skylot/jadx) ⭐ 50,568 | 🐛 449 | 🌐 Java | 📅 2026-09-12 - Decompiles APKs into Java source code.
* [FernFlower](https://github.com/JetBrains/intellij-community/tree/master/plugins/java-decompiler/engine) ⭐ 20,582 | 🐛 154 | 🌐 Java | 📅 2026-09-22 - Analytical decompiler for Java.
* [DEX2JAR](https://github.com/pxb1988/dex2jar) ⭐ 13,145 | 🐛 379 | 🌐 Java | 📅 2024-07-21 - Converts DEX files to JAR files.
* [Cfr](https://github.com/leibnitz27/cfr) ⭐ 2,699 | 🐛 151 | 🌐 Java | 📅 2026-06-04 - Supports decompilation of Android APK files.
...
* **Additional Decompilers:**
  * [Androguard](https://github.com/androguard/androguard) ⭐ 6,282 | 🐛 0 | 🌐 Python | 📅 2026-09-22 - Analyzes and reverse engineers Android apps.
  * [APK Studio](https://github.com/vaibhavpandeyvpz/apkstudio) ⭐ 4,661 | 🐛 4 | 🌐 C++ | 📅 2026-01-05 - Qt-based IDE for reverse-engineering APKs.
...
* [☆ UnCrackable Mobile Apps](https://github.com/OWASP/owasp-mastg/tree/master/Crackmes) ⭐ 13,195 | 🐛 240 | 🌐 Python | 📅 2026-09-20 - OWASP Android app CrackMes.
...
* [uber-apk-signer](https://github.com/patrickfav/uber-apk-signer) ⭐ 2,754 | 🐛 11 | 🌐 Java | 📅 2023-10-30 - CLI tool for signing and zip aligning APKs.
* [LADB](https://github.com/tytydraco/LADB) ⭐ 2,411 | 🐛 53 | 🌐 Kotlin | 📅 2026-07-26 - Local ADB shell for Android.
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,363 | 🐛 94 | 🌐 Rust | 📅 2026-08-11 - Analyze, extract, and reverse engineer firmware images.
