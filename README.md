...
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,829 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-23 - Supports both static and dynamic analysis for Android app security testing.
...
* **Networking:**
  * [apk-mitm](https://github.com/shroudedcode/apk-mitm) ⭐ 5,115 | 🐛 83 | 🌐 TypeScript | 📅 2024-07-24 - Prepares APKs for HTTPS inspection.
...
* **Dynamic Instrumentation:**
  * [☆ Objection](https://github.com/sensepost/objection) ⭐ 9,406 | 🐛 58 | 🌐 Python | 📅 2026-09-17 - Runtime exploration tool to bypass app security controls.
  * [RMS Runtime Mobile Security](https://github.com/m0bilesecurity/RMS-Runtime-Mobile-Security) ⭐ 3,092 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-03 - Frida web interface.
...
* [☆ JADX](https://github.com/skylot/jadx) ⭐ 50,620 | 🐛 453 | 🌐 Java | 📅 2026-09-12 - Decompiles APKs into Java source code.
* [FernFlower](https://github.com/JetBrains/intellij-community/tree/master/plugins/java-decompiler/engine) ⭐ 20,588 | 🐛 152 | 🌐 Java | 📅 2026-09-25 - Analytical decompiler for Java.
* [DEX2JAR](https://github.com/pxb1988/dex2jar) ⭐ 13,146 | 🐛 379 | 🌐 Java | 📅 2024-07-21 - Converts DEX files to JAR files.
* [Cfr](https://github.com/leibnitz27/cfr) ⭐ 2,703 | 🐛 151 | 🌐 Java | 📅 2026-06-04 - Supports decompilation of Android APK files.
...
* **Additional Decompilers:**
  * [Androguard](https://github.com/androguard/androguard) ⭐ 6,291 | 🐛 1 | 🌐 Python | 📅 2026-09-22 - Analyzes and reverse engineers Android apps.
  * [APK Studio](https://github.com/vaibhavpandeyvpz/apkstudio) ⭐ 4,664 | 🐛 4 | 🌐 C++ | 📅 2026-01-05 - Qt-based IDE for reverse-engineering APKs.
...
* [Android Reverse Engineering Challenges](https://github.com/apsdehal/awesome-ctf#reverse-engineering) ⭐ 11,862 | 🐛 68 | 🌐 JavaScript | 📅 2024-07-22 - Curated list of reverse engineering challenges and CTFs.
...
* [☆ UnCrackable Mobile Apps](https://github.com/OWASP/owasp-mastg/tree/master/Crackmes) ⭐ 13,202 | 🐛 242 | 🌐 Python | 📅 2026-09-20 - OWASP Android app CrackMes.
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,371 | 🐛 96 | 🌐 Rust | 📅 2026-08-11 - Analyze, extract, and reverse engineer firmware images.
