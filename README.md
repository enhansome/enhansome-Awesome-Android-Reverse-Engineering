...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/MarketingPipeline/Awesome-Repo-Template/) ⭐ 212 | 🐛 0 | 🌐 HTML | 📅 2023-03-03
...
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,766 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-09 - Supports both static and dynamic analysis for Android app security testing.
* [QARK](https://github.com/linkedin/qark) ⭐ 3,386 | 🐛 79 | 🌐 Python | 📅 2024-01-16 - An open-source tool for automatic Android app vulnerability scanning.
* [Quark Engine](https://github.com/quark-engine/quark-engine) ⭐ 1,718 | 🐛 76 | 🌐 Python | 📅 2026-09-08 - Integrates various tools as Quark Script APIs for mobile security research.
...
* [Dexcalibur](https://github.com/FrenchYeti/dexcalibur) ⭐ 1,172 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-13 - Automated tool for analyzing and instrumenting Android applications.
...
* [simplify](https://github.com/CalebFenton/simplify) ⭐ 4,662 | 🐛 33 | 🌐 Java | 📅 2022-04-30 - Android virtual machine and deobfuscator.
...
* [Drozer](https://github.com/WithSecureLabs/drozer) ⭐ 4,611 | 🐛 9 | 🌐 Python | 📅 2026-04-08 - Framework for Android security testing with dynamic analysis features.
...
* **Networking:**
  * [apk-mitm](https://github.com/shroudedcode/apk-mitm) ⭐ 5,110 | 🐛 83 | 🌐 TypeScript | 📅 2024-07-24 - Prepares APKs for HTTPS inspection.
  * [SSLsplit](https://github.com/droe/sslsplit) ⭐ 1,878 | 🐛 76 | 🌐 C | 📅 2025-10-27 - Intercepts and manipulates SSL/TLS encrypted traffic.
...
* **Dynamic Instrumentation:**
  * [☆ Objection](https://github.com/sensepost/objection) ⭐ 9,384 | 🐛 57 | 🌐 Python | 📅 2026-07-23 - Runtime exploration tool to bypass app security controls.
  * [RMS Runtime Mobile Security](https://github.com/m0bilesecurity/RMS-Runtime-Mobile-Security) ⭐ 3,085 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-03 - Frida web interface.
  * [jnitrace](https://github.com/chame1eon/jnitrace) ⭐ 1,862 | 🐛 20 | 🌐 TypeScript | 📅 2023-07-18 - Frida-based JNI API tracer.
  * [☆ FriDump](https://github.com/Nightbringer21/fridump) ⭐ 861 | 🐛 27 | 🌐 Python | 📅 2024-08-07 - Uses Frida to dump memory of running apps.
  * [☆ Binder Trace](https://github.com/foundryzero/binder-trace) ⭐ 769 | 🐛 11 | 🌐 Python | 📅 2025-09-11 - Intercepts and parses Android Binder messages.
...
* [☆ JADX](https://github.com/skylot/jadx) ⭐ 50,458 | 🐛 446 | 🌐 Java | 📅 2026-09-12 - Decompiles APKs into Java source code.
* [FernFlower](https://github.com/JetBrains/intellij-community/tree/master/plugins/java-decompiler/engine) ⭐ 20,549 | 🐛 160 | 🌐 Java | 📅 2026-09-14 - Analytical decompiler for Java.
* [DEX2JAR](https://github.com/pxb1988/dex2jar) ⭐ 13,141 | 🐛 379 | 🌐 Java | 📅 2024-07-21 - Converts DEX files to JAR files.
* [Cfr](https://github.com/leibnitz27/cfr) ⭐ 2,697 | 🐛 150 | 🌐 Java | 📅 2026-06-04 - Supports decompilation of Android APK files.
* [Procyon](https://github.com/mstrobel/procyon) ⭐ 1,216 | 🐛 59 | 🌐 Java | 📅 2022-06-12 - Suite of Java decompilation tools.
...
* **Additional Decompilers:**
  * [Androguard](https://github.com/androguard/androguard) ⭐ 6,242 | 🐛 46 | 🌐 Python | 📅 2026-09-04 - Analyzes and reverse engineers Android apps.
  * [APK Studio](https://github.com/vaibhavpandeyvpz/apkstudio) ⭐ 4,650 | 🐛 4 | 🌐 C++ | 📅 2026-01-05 - Qt-based IDE for reverse-engineering APKs.
  * [show-java](https://github.com/niranjan94/show-java) ⭐ 790 | 🐛 53 | 🌐 Kotlin | 📅 2023-01-04 - APK, JAR & Dex decompiler.
...
* [Android Reverse Engineering Challenges](https://github.com/apsdehal/awesome-ctf#reverse-engineering) ⭐ 11,846 | 🐛 67 | 🌐 JavaScript | 📅 2024-07-22 - Curated list of reverse engineering challenges and CTFs.
...
* [☆ UnCrackable Mobile Apps](https://github.com/OWASP/owasp-mastg/tree/master/Crackmes) ⭐ 13,182 | 🐛 236 | 🌐 Python | 📅 2026-09-14 - OWASP Android app CrackMes.
...
* [uber-apk-signer](https://github.com/patrickfav/uber-apk-signer) ⭐ 2,744 | 🐛 11 | 🌐 Java | 📅 2023-10-30 - CLI tool for signing and zip aligning APKs.
* [LADB](https://github.com/tytydraco/LADB) ⭐ 2,404 | 🐛 53 | 🌐 Kotlin | 📅 2026-07-26 - Local ADB shell for Android.
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,338 | 🐛 92 | 🌐 Rust | 📅 2026-08-11 - Analyze, extract, and reverse engineer firmware images.
* [FirmWire](https://github.com/FirmWire/FirmWire) ⭐ 883 | 🐛 17 | 🌐 Python | 📅 2026-08-20 - Dynamic analysis platform for baseband firmware.
