...
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,818 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-23 - Supports both static and dynamic analysis for Android app security testing.
...
* [Quark Engine](https://github.com/quark-engine/quark-engine) ⭐ 1,725 | 🐛 77 | 🌐 Python | 📅 2026-09-19 - Integrates various tools as Quark Script APIs for mobile security research.
...
* [simplify](https://github.com/CalebFenton/simplify) ⭐ 4,667 | 🐛 33 | 🌐 Java | 📅 2022-04-30 - Android virtual machine and deobfuscator.
...
* **Dynamic Instrumentation:**
  * [☆ Objection](https://github.com/sensepost/objection) ⭐ 9,403 | 🐛 58 | 🌐 Python | 📅 2026-09-17 - Runtime exploration tool to bypass app security controls.
...
* [☆ JADX](https://github.com/skylot/jadx) ⭐ 50,582 | 🐛 449 | 🌐 Java | 📅 2026-09-12 - Decompiles APKs into Java source code.
* [FernFlower](https://github.com/JetBrains/intellij-community/tree/master/plugins/java-decompiler/engine) ⭐ 20,588 | 🐛 155 | 🌐 Java | 📅 2026-09-23 - Analytical decompiler for Java.
* [DEX2JAR](https://github.com/pxb1988/dex2jar) ⭐ 13,145 | 🐛 379 | 🌐 Java | 📅 2024-07-21 - Converts DEX files to JAR files.
* [Cfr](https://github.com/leibnitz27/cfr) ⭐ 2,701 | 🐛 151 | 🌐 Java | 📅 2026-06-04 - Supports decompilation of Android APK files.
...
* **Additional Decompilers:**
  * [Androguard](https://github.com/androguard/androguard) ⭐ 6,286 | 🐛 0 | 🌐 Python | 📅 2026-09-22 - Analyzes and reverse engineers Android apps.
  * [APK Studio](https://github.com/vaibhavpandeyvpz/apkstudio) ⭐ 4,663 | 🐛 4 | 🌐 C++ | 📅 2026-01-05 - Qt-based IDE for reverse-engineering APKs.
...
* [Android Reverse Engineering Challenges](https://github.com/apsdehal/awesome-ctf#reverse-engineering) ⭐ 11,863 | 🐛 68 | 🌐 JavaScript | 📅 2024-07-22 - Curated list of reverse engineering challenges and CTFs.
...
* [☆ UnCrackable Mobile Apps](https://github.com/OWASP/owasp-mastg/tree/master/Crackmes) ⭐ 13,198 | 🐛 241 | 🌐 Python | 📅 2026-09-20 - OWASP Android app CrackMes.
...
* [LADB](https://github.com/tytydraco/LADB) ⭐ 2,412 | 🐛 53 | 🌐 Kotlin | 📅 2026-07-26 - Local ADB shell for Android.
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,366 | 🐛 95 | 🌐 Rust | 📅 2026-08-11 - Analyze, extract, and reverse engineer firmware images.
