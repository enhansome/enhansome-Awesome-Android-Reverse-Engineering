...
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,747 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-09 - Supports both static and dynamic analysis for Android app security testing.
...
* [Quark Engine](https://github.com/quark-engine/quark-engine) ⭐ 1,716 | 🐛 76 | 🌐 Python | 📅 2026-09-08 - Integrates various tools as Quark Script APIs for mobile security research.
...
* [Dexcalibur](https://github.com/FrenchYeti/dexcalibur) ⭐ 1,172 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-06 - Automated tool for analyzing and instrumenting Android applications.
...
* [Drozer](https://github.com/WithSecureLabs/drozer) ⭐ 4,608 | 🐛 9 | 🌐 Python | 📅 2026-04-08 - Framework for Android security testing with dynamic analysis features.
...
* **Networking:**
  * [apk-mitm](https://github.com/shroudedcode/apk-mitm) ⭐ 5,107 | 🐛 83 | 🌐 TypeScript | 📅 2024-07-24 - Prepares APKs for HTTPS inspection.
...
* **Dynamic Instrumentation:**
  * [☆ Objection](https://github.com/sensepost/objection) ⭐ 9,380 | 🐛 57 | 🌐 Python | 📅 2026-07-23 - Runtime exploration tool to bypass app security controls.
  * [RMS Runtime Mobile Security](https://github.com/m0bilesecurity/RMS-Runtime-Mobile-Security) ⭐ 3,083 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-03 - Frida web interface.
...
* [☆ JADX](https://github.com/skylot/jadx) ⭐ 50,413 | 🐛 446 | 🌐 Java | 📅 2026-09-08 - Decompiles APKs into Java source code.
* [FernFlower](https://github.com/JetBrains/intellij-community/tree/master/plugins/java-decompiler/engine) ⭐ 20,544 | 🐛 161 | 🌐 Java | 📅 2026-09-11 - Analytical decompiler for Java.
* [DEX2JAR](https://github.com/pxb1988/dex2jar) ⭐ 13,139 | 🐛 379 | 🌐 Java | 📅 2024-07-21 - Converts DEX files to JAR files.
* [Cfr](https://github.com/leibnitz27/cfr) ⭐ 2,695 | 🐛 150 | 🌐 Java | 📅 2026-06-04 - Supports decompilation of Android APK files.
...
* **Additional Decompilers:**
  * [Androguard](https://github.com/androguard/androguard) ⭐ 6,238 | 🐛 46 | 🌐 Python | 📅 2026-09-04 - Analyzes and reverse engineers Android apps.
  * [APK Studio](https://github.com/vaibhavpandeyvpz/apkstudio) ⭐ 4,645 | 🐛 4 | 🌐 C++ | 📅 2026-01-05 - Qt-based IDE for reverse-engineering APKs.
...
* [Android Reverse Engineering Challenges](https://github.com/apsdehal/awesome-ctf#reverse-engineering) ⭐ 11,841 | 🐛 67 | 🌐 JavaScript | 📅 2024-07-22 - Curated list of reverse engineering challenges and CTFs.
...
* [☆ UnCrackable Mobile Apps](https://github.com/OWASP/owasp-mastg/tree/master/Crackmes) ⭐ 13,177 | 🐛 239 | 🌐 Python | 📅 2026-09-11 - OWASP Android app CrackMes.
...
* [uber-apk-signer](https://github.com/patrickfav/uber-apk-signer) ⭐ 2,741 | 🐛 11 | 🌐 Java | 📅 2023-10-30 - CLI tool for signing and zip aligning APKs.
* [LADB](https://github.com/tytydraco/LADB) ⭐ 2,402 | 🐛 53 | 🌐 Kotlin | 📅 2026-07-26 - Local ADB shell for Android.
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,332 | 🐛 93 | 🌐 Rust | 📅 2026-08-11 - Analyze, extract, and reverse engineer firmware images.
* [FirmWire](https://github.com/FirmWire/FirmWire) ⭐ 881 | 🐛 17 | 🌐 Python | 📅 2026-08-20 - Dynamic analysis platform for baseband firmware.
