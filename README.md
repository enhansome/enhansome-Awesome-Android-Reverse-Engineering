...
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,760 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-09 - Supports both static and dynamic analysis for Android app security testing.
* [QARK](https://github.com/linkedin/qark) ⭐ 3,385 | 🐛 79 | 🌐 Python | 📅 2024-01-16 - An open-source tool for automatic Android app vulnerability scanning.
* [Quark Engine](https://github.com/quark-engine/quark-engine) ⭐ 1,717 | 🐛 76 | 🌐 Python | 📅 2026-09-08 - Integrates various tools as Quark Script APIs for mobile security research.
...
* **Networking:**
  * [apk-mitm](https://github.com/shroudedcode/apk-mitm) ⭐ 5,109 | 🐛 83 | 🌐 TypeScript | 📅 2024-07-24 - Prepares APKs for HTTPS inspection.
...
* [☆ JADX](https://github.com/skylot/jadx) ⭐ 50,447 | 🐛 445 | 🌐 Java | 📅 2026-09-12 - Decompiles APKs into Java source code.
* [FernFlower](https://github.com/JetBrains/intellij-community/tree/master/plugins/java-decompiler/engine) ⭐ 20,548 | 🐛 163 | 🌐 Java | 📅 2026-09-13 - Analytical decompiler for Java.
* [DEX2JAR](https://github.com/pxb1988/dex2jar) ⭐ 13,140 | 🐛 379 | 🌐 Java | 📅 2024-07-21 - Converts DEX files to JAR files.
* [Cfr](https://github.com/leibnitz27/cfr) ⭐ 2,696 | 🐛 150 | 🌐 Java | 📅 2026-06-04 - Supports decompilation of Android APK files.
...
* **Additional Decompilers:**
  * [Androguard](https://github.com/androguard/androguard) ⭐ 6,241 | 🐛 46 | 🌐 Python | 📅 2026-09-04 - Analyzes and reverse engineers Android apps.
  * [APK Studio](https://github.com/vaibhavpandeyvpz/apkstudio) ⭐ 4,647 | 🐛 4 | 🌐 C++ | 📅 2026-01-05 - Qt-based IDE for reverse-engineering APKs.
...
* [Android Reverse Engineering Challenges](https://github.com/apsdehal/awesome-ctf#reverse-engineering) ⭐ 11,843 | 🐛 67 | 🌐 JavaScript | 📅 2024-07-22 - Curated list of reverse engineering challenges and CTFs.
...
* [☆ UnCrackable Mobile Apps](https://github.com/OWASP/owasp-mastg/tree/master/Crackmes) ⭐ 13,180 | 🐛 239 | 🌐 Python | 📅 2026-09-12 - OWASP Android app CrackMes.
...
* [uber-apk-signer](https://github.com/patrickfav/uber-apk-signer) ⭐ 2,743 | 🐛 11 | 🌐 Java | 📅 2023-10-30 - CLI tool for signing and zip aligning APKs.
* [LADB](https://github.com/tytydraco/LADB) ⭐ 2,403 | 🐛 53 | 🌐 Kotlin | 📅 2026-07-26 - Local ADB shell for Android.
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,335 | 🐛 93 | 🌐 Rust | 📅 2026-08-11 - Analyze, extract, and reverse engineer firmware images.
