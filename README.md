...
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,710 | 🐛 30 | 🌐 JavaScript | 📅 2026-09-02 - Supports both static and dynamic analysis for Android app security testing.
...
* [Dexcalibur](https://github.com/FrenchYeti/dexcalibur) ⭐ 1,171 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-05 - Automated tool for analyzing and instrumenting Android applications.
...
* [simplify](https://github.com/CalebFenton/simplify) ⭐ 4,660 | 🐛 33 | 🌐 Java | 📅 2022-04-30 - Android virtual machine and deobfuscator.
...
* [Drozer](https://github.com/WithSecureLabs/drozer) ⭐ 4,604 | 🐛 9 | 🌐 Python | 📅 2026-04-08 - Framework for Android security testing with dynamic analysis features.
...
* **Dynamic Instrumentation:**
  * [☆ Objection](https://github.com/sensepost/objection) ⭐ 9,367 | 🐛 57 | 🌐 Python | 📅 2026-07-23 - Runtime exploration tool to bypass app security controls.
  * [RMS Runtime Mobile Security](https://github.com/m0bilesecurity/RMS-Runtime-Mobile-Security) ⭐ 3,081 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-03 - Frida web interface.
...
* [☆ JADX](https://github.com/skylot/jadx) ⭐ 50,358 | 🐛 447 | 🌐 Java | 📅 2026-09-02 - Decompiles APKs into Java source code.
* [FernFlower](https://github.com/JetBrains/intellij-community/tree/master/plugins/java-decompiler/engine) ⭐ 20,522 | 🐛 160 | 🌐 Java | 📅 2026-09-06 - Analytical decompiler for Java.
...
* **Additional Decompilers:**
  * [Androguard](https://github.com/androguard/androguard) ⭐ 6,229 | 🐛 46 | 🌐 Python | 📅 2026-09-04 - Analyzes and reverse engineers Android apps.
  * [APK Studio](https://github.com/vaibhavpandeyvpz/apkstudio) ⭐ 4,642 | 🐛 4 | 🌐 C++ | 📅 2026-01-05 - Qt-based IDE for reverse-engineering APKs.
...
* [☆ UnCrackable Mobile Apps](https://github.com/OWASP/owasp-mastg/tree/master/Crackmes) ⭐ 13,155 | 🐛 238 | 🌐 Python | 📅 2026-09-04 - OWASP Android app CrackMes.
...
* [uber-apk-signer](https://github.com/patrickfav/uber-apk-signer) ⭐ 2,730 | 🐛 11 | 🌐 Java | 📅 2023-10-30 - CLI tool for signing and zip aligning APKs.
* [LADB](https://github.com/tytydraco/LADB) ⭐ 2,396 | 🐛 53 | 🌐 Kotlin | 📅 2026-07-26 - Local ADB shell for Android.
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,317 | 🐛 93 | 🌐 Rust | 📅 2026-08-11 - Analyze, extract, and reverse engineer firmware images.
