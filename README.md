...
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,805 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-21 - Supports both static and dynamic analysis for Android app security testing.
...
* [Drozer](https://github.com/WithSecureLabs/drozer) ⭐ 4,617 | 🐛 9 | 🌐 Python | 📅 2026-04-08 - Framework for Android security testing with dynamic analysis features.
...
* **Dynamic Instrumentation:**
  * [☆ Objection](https://github.com/sensepost/objection) ⭐ 9,402 | 🐛 57 | 🌐 Python | 📅 2026-09-17 - Runtime exploration tool to bypass app security controls.
...
* [☆ JADX](https://github.com/skylot/jadx) ⭐ 50,548 | 🐛 450 | 🌐 Java | 📅 2026-09-12 - Decompiles APKs into Java source code.
* [FernFlower](https://github.com/JetBrains/intellij-community/tree/master/plugins/java-decompiler/engine) ⭐ 20,576 | 🐛 155 | 🌐 Java | 📅 2026-09-21 - Analytical decompiler for Java.
* [DEX2JAR](https://github.com/pxb1988/dex2jar) ⭐ 13,143 | 🐛 379 | 🌐 Java | 📅 2024-07-21 - Converts DEX files to JAR files.
* [Cfr](https://github.com/leibnitz27/cfr) ⭐ 2,699 | 🐛 150 | 🌐 Java | 📅 2026-06-04 - Supports decompilation of Android APK files.
...
* **Additional Decompilers:**
  * [Androguard](https://github.com/androguard/androguard) ⭐ 6,278 | 🐛 45 | 🌐 Python | 📅 2026-09-19 - Analyzes and reverse engineers Android apps.
  * [APK Studio](https://github.com/vaibhavpandeyvpz/apkstudio) ⭐ 4,659 | 🐛 4 | 🌐 C++ | 📅 2026-01-05 - Qt-based IDE for reverse-engineering APKs.
...
* [☆ UnCrackable Mobile Apps](https://github.com/OWASP/owasp-mastg/tree/master/Crackmes) ⭐ 13,190 | 🐛 239 | 🌐 Python | 📅 2026-09-20 - OWASP Android app CrackMes.
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,360 | 🐛 94 | 🌐 Rust | 📅 2026-08-11 - Analyze, extract, and reverse engineer firmware images.
